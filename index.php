...
<br><br><br><br>
             ...
             if ($query_recent_properties->count(true)) {
                 foreach ($query_recent_properties as $row) {
                     ...
                     if (count($pictures)>1) {
                      ...
                      <div class="thumbnail"><img src=\'assets/img/'.$property_name.'/'.$property_name.$pictures[0].'\' style="height:150px">
                        <div class="caption">
                             <h3>'. $property_name .'</h3>
 ...
 <div class="container">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><h1 class="text-left">Our Partners</h1></div>

        <div class="col-lg-4 col-md-12 text-center"><img src="assets/img/betterhalf_ai.jpg"></div>
        <div class="col-lg-4 col-md-12 text-center" ><img src="assets/img/jobjinny_com.jpg"></div>
        <div class="col-lg-4 col-md-12 text-center"><img src="assets/img/dynobolt_com.jpg"></div>
    </div>
