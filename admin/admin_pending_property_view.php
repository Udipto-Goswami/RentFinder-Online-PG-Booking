                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            ...
                            <?php 
                                    ...
                                    $query_all_property = $property_collection->find(array("approved" =>"0"));
                                           ...
                                           $qid = $row['_id'];
                                            echo ' <tr>
                                                        ...
                                                        if($app=="0")   {
                                                            ...
                                                            echo'<td><a href="includes_admin/update_status_property.php?id=' .$qid .'&active=1&stat=1" class="btn btn-success btn-xs">&nbsp Activate &nbsp&nbsp</a></td>';
                                                        }
                                                        else{
                                                             echo'<td class="bg-success"><span class="text-success">Active</span></td>';
                                                            echo'<td><a href="includes_admin/update_status_property.php?id=' .$qid .'&active=2&stat=1" class="btn btn-danger btn-xs">Deactivate</a></td>';
                                                        }
                                                    echo '</tr>';
                                        }
                                    }
                                    else{
                                      echo "<tr><td>NO Properties Pending!</td></tr> ";
                                    }
